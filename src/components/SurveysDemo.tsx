...
// device ships. Fillers (noSeedDevice) are pagination-only props and are excluded
// so they never pollute People.
...
// Emails of the filler testers — used once to purge any fillers that were
// previously seeded into a persisted People store before they were excluded.
